              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="flex-1 text-sm sm:text-base font-semibold text-white pr-2">{faq.question}</h3>
                    {isOpen ? (
                  ...
                  >
                    <p className="pl-16 sm:pl-20 pr-4 sm:pr-6 pb-4 sm:pb-6 text-neutral-300 text-xs sm:text-sm leading-relaxed">
                      {faq.answer}
                    </p>
                  </div>
                </div>
