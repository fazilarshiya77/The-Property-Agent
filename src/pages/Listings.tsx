...
export default function Listings() {
  ...
  const pageDescription = `Browse ${filteredProperties.length}+ verified properties ${typeLabel.toLowerCase()} in ${locationLabel}, Bangalore. Filter by location, price, bedrooms, and type. Find your perfect home with Trishna Properties. 2BHK, 3BHK, 4BHK apartments and houses available. Every listing personally verified.`;
      ...
      <div className="bg-white border-b border-neutral-100">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3">
          ...
          <p className="text-neutral-500 text-xs sm:text-sm mt-2 leading-relaxed max-w-3xl">
            {selectedLocation !== 'all'
              ? `Explore verified properties ${typeLabel.toLowerCase()} in ${selectedLocation}, Bangalore. All listings are personally inspected by the Trishna Properties team. Find 2BHK, 3BHK, and 4BHK homes in ${selectedLocation} with transparent pricing and no hidden charges.`
