...
const aboutFaqData: FAQItem[] = [
  {
    question: "How can I contact Trishna Properties?",
    answer: "You can reach Trishna Properties by phone at +91 98861 04532, email at trishnaproperties78@gmail.com, or visit our office at 31, GM Palya Main Rd, KG Colony, GM Palya, C V Raman Nagar, Bengaluru, Karnataka 560075. We are open Monday to Saturday, 9 AM to 7 PM."
  },
  {
    question: "What services does Trishna Properties offer?",
    answer: "Trishna Properties offers comprehensive real estate services in Bangalore including: rental property search and placement, property buying and selling assistance for premium projects (Brigade, Godrej, Mahindra), property management, tenant verification, rental agreement preparation, and end-to-end move-in support."
  },
  {
    question: "How many properties does Trishna Properties have listed?",
    answer: "Trishna Properties currently has 50+ verified property listings across 10+ prime locations in Bangalore. Our portfolio includes rental apartments in Murgeshpalya, CV Raman Nagar, and GM Palya, as well as premium sale properties from Brigade Group, Godrej Properties, and Mahindra Lifespaces."
  }
];
...
export default function About() {
  ...
  return (
    <div className="min-h-screen" itemScope itemType="https://schema.org/AboutPage">
      <SEO
        title="About Trishna Properties — Trusted Real Estate Agent in Bangalore"
        description="Learn about Trishna Properties (Prishna Properties), Bangalore's trusted real estate agency. 50+ verified properties, 200+ happy families, 5+ years of experience. Specializing in premium rental homes and properties for sale in Murgeshpalya, CV Raman Nagar, GM Palya, Whitefield, Sarjapur Road & more."
        keywords="about Trishna Properties, Prishna Properties Bangalore, real estate agent Bangalore, property management Bangalore, trusted realtor Bangalore, GM Palya real estate, Bengaluru property consultant, verified properties agent, East Bangalore realtor, property dealer Murgeshpalya"
        type="website"
        canonicalPath="/about"
      ...
      {/* Hero */}
      <section className="relative py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-navy-900 to-navy-950 overflow-hidden" aria-label="About Trishna Properties">
          ...
          <div ref={storyRef} className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="rounded-2xl overflow-hidden shadow-card-hover">
              <img
                ...
                alt="Premium apartment interior showcasing quality properties managed by Trishna Properties in Bangalore"
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white" aria-label="What makes Trishna Properties different">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div ref={diffHeaderRef} className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-navy-900 mb-3">What Makes Trishna Properties Different</h2>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-neutral-50" aria-label="Visit our office in Bangalore" itemScope itemType="https://schema.org/LocalBusiness">
        <meta itemProp="name" content="Trishna Properties" />
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          ...
          <div ref={officeRef} className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-3 rounded-2xl overflow-hidden shadow-card border border-neutral-100 bg-white">
              <iframe
                src={mapsEmbed}
                title="Trishna Properties office location — GM Palya, CV Raman Nagar, Bengaluru"
                className="w-full h-64 sm:h-80 lg:h-96"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                style={{ border: 0 }}
                allowFullScreen
                aria-label="Google Maps showing Trishna Properties office at GM Palya, Bengaluru"
              />
            </div>
            ...
            <div className="lg:col-span-2 bg-white rounded-2xl shadow-card p-6 sm:p-8 flex flex-col justify-center">
              <div className="flex items-center space-x-3 mb-6">
                <img src="/logo.jpeg" alt="Trishna Properties logo" className="h-12 w-12 rounded-xl object-contain bg-white shadow-sm border border-neutral-100" width="48" height="48" />
                <div>
                  <h3 className="font-display font-bold text-navy-900 tracking-wide" itemProp="legalName">Trishna Properties</h3>
              ...
              <div className="space-y-4" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
                ...
                <a
                  ...
                  aria-label="Open Trishna Properties office location in Google Maps"
                >
      ...
      {/* Contact Section */}
      <section id="contact" className="py-12 sm:py-16 lg:py-20 bg-white" aria-label="Contact Trishna Properties">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div ref={contactRef} className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <div>
              ...
              <p className="text-neutral-600 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
                Whether you're looking for a <strong>rental home in East Bangalore</strong>, want to <strong>buy a premium apartment from Brigade, Godrej, or Mahindra</strong>, or list your property with us, we'd love to hear from you. Contact Trishna Properties today for expert real estate guidance.
              </p>
