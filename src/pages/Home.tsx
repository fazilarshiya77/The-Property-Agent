      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-neutral-50" aria-label="Bangalore neighborhood rental guides">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <article className="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-neutral-100">
              <h3 className="text-base sm:text-lg font-semibold text-navy-900 mb-2">Sarjapur Road — High Growth Investment Destination</h3>
              <p className="text-neutral-600 text-xs sm:text-sm leading-relaxed">
                Sarjapur Road is one of Bangalore's fastest-growing residential corridors, connecting to major tech hubs like Wipro SEZ and RGA Tech Park. Premium projects like Godrej Lakeside Orchard offer luxury living with a grand 48,000 sqft clubhouse and 50+ amenities. Apartments range from 1,215 to 2,668 sqft with prices starting at ₹1.5 Cr — excellent for both end-users and investors.
              </p>
              <Link to="/listings?location=Sarjapur+Road" className="inline-flex items-center text-brand-500 text-xs sm:text-sm font-semibold mt-3 hover:text-brand-600 transition-colors">
                View Sarjapur Road properties <ArrowRight className="h-3.5 w-3.5 ml-1" aria-hidden="true" />
              </Link>
            </article>
          </div>
        </div>
